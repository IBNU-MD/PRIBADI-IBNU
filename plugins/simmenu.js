...
const fkgif = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text":`IBNU-MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `IBNU-MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
...
┏━━━ꕥ〔 *BOT INFO* 〕ꕥ━⬣
┃✾ *Bot Name:* ${namabot}
┃✾ *Creator:* IBNU OFFICIAL 🅥⁩ 
┃✾ *Contact Owner Bot:*
┃http://wa.me/6281807254833
┃✾ *Tanggal:* ${date}
┃✾ *Jam:* ${time} WIB
┃✾ *Status:* 「 ${mode} 」
┃✾ *Prefix:* 「 MULTI PREFIX 」
 ...
 *Official Bot By @${'0'.split('@')[0]}* 
 *Powered By @${'6281807254833'.split('@')[0]}*`
       let judul = `${ucapanl()}`.trim() 
       const sections = [
                              {
                                "rows": [{
                                         "title": "📊 › Status ",
                                         "description": "Status IBNU-MD",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon IBNU-MD",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
                                         "description": "Menampilkan Info IBNU-MD",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › Developer Bot ",
